...
Mã hóa và giải mã file text sử dụng thuật toán DES (Data Encryption Standard)
⚠️ CẢNH BÁO: DES không an toàn - chỉ dùng cho mục đích học tập!
"""
...
class DESCipher:
    def __init__(self):
        """
        Khởi tạo DES cipher
        DES có key size cố định là 8 bytes (64 bits, trong đó 8 bits là parity)
        """
...
def main():
    """
    Giao diện chính cho DES cipher
    """
    print("=== DES Cipher - Mã hóa File Text ===")
    print("⚠️ CẢNH BÁO: DES chỉ nên dùng cho mục đích học tập!")
